...
# KLTODO what to do about clearStack?
...
#              for sl in range(zsupercubedim):
  ...
  #                  newdata[sl, :, :] = np.asarray(slimage.resize([xsupercubedim, ysupercubedim]))
                ...
                # setup the cube to receive data
...
# @KL not sure what you changed here.  It was a giant merge conflict.
#    I think it's the supercubedim stuff.
