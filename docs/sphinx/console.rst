...
============================
Navigate to http://cloud.neurodata.io/nd/accounts/login/ and if you do not have an account select the register option below the sign in box. Once you create an account log into the console and you will be taken to the main page.
