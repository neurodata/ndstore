...
#    pass
  ...
  def setup_class(self):
    ...
    with closing ( ocpcaproj.OCPCAProjectsDB() ) as pd:
      try:
        pd.newOCPCAProj ( 'pubunittest', 'test', 'localhost', 'pubunittest', 'annotation', 'uint32', 'kasthuri11', None, False, True,  False, 0, True, kvengine_to_test.kvserver, kvengine_to_test.kvengine, 0 )
      except:
