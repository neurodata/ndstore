...
ND_STATS_PATH = os.path.join(OCP_BASE_PATH, "stats" )
...
sys.path += [ ND_UTIL_PATH, ND_WS_PATH, ND_SPDB_PATH, ND_STATS_PATH, ND_PROJ_PATH, ND_RAMON_PATH, ND_LIB_PATH, ND_DJANGO_PATH ]
