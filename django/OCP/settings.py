...
from ocppaths import OCP_DJANGO_PATH
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(OCP_DJANGO_PATH, 'templates/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.path.join(OCP_DJANGO_PATH, 'templates/static')

# Additional locations of static files
STATICFILES_DIRS = (
  os.path.join(OCP_DJANGO_PATH, "static/"),
)
