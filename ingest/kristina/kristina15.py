...
class Ingest_Data:
  ...
  def __init__(self, path, resolution):
    ...
    self.endWindows = [18603, 19194, 16383, 17391, 18317, 17573, 16383, 18480, 18848, 18711, 18441, 17956, 16383, 18051, 17806, 18893, 19261, 17562, 20017, 18504, 17043, 18083, 17875, 16383]

    self.project_name = 'kristina15'  # needed for creating channels
    # contains the names for each of the channels in this folder
    #channels_names = ["5HT1A_6th", "CR1_2ndA"]
  ...
  def createProject(self):
    ...
    try:
      ...
      new_project.description = "Autogenerated from folder {} using dataset {}".format(
      ...
      tk = Token(token_name=new_project.project_name, token_description='Default token for project {}'.format(
  ...
  def createChannel(self, name, chnum):
    ...
    try:
      ...
      new_channel.channel_description = 'Autogenerated for project {}, dataset {}, channel num {}'.format(
          self.project_name, self.dataset_name, chnum)
      ...
      new_channel.endwindow = self.endWindows[chnum]
      new_channel.save()
